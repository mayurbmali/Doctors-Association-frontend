    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <section className="bg-gradient-to-br from-orange-500 to-orange-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Leading Homoeopathic Excellence
              <span className="block text-green-400">Maharashtra</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <Button asChild className="bg-orange-500 hover:bg-orange-600 transition-all duration-400">
                <Link to="/history-achieve">
                  Explore Our History <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </Button>
          ...
          {/* Core Values */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-400">
              <CardContent className="p-0">
                <div className="glass-icon inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 mx-auto" role="img" aria-label="Excellence icon">
                  <Heart className="w-9 h-9 text-white drop-shadow-lg" strokeWidth={2.5} />
                </div>
          ...
          {/* Leadership Message */}
          <Card className="bg-gradient-to-r from-orange-50 to-green-50 border-none">
            <CardContent className="p-12 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Leadership Message
              </h3>
      ...
      <section className="bg-orange-500 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-green-500 hover:bg-green-600 transition-all duration-400">
              <Link to="/membership">
                Become a Member
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-orange-600 transition-all duration-400">
              <Link to="/contact">
                Contact Us
              </Link>
            </Button>
