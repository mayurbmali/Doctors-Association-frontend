...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-green-500/10 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 py-16 lg:py-20">
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                />
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">CCMP</h3>
                  <p className="text-sm text-neutral-400">Maharashtra</p>
                </div>
              </div>
              <h4 className="text-2xl lg:text-3xl font-bold mb-6 leading-tight text-neutral-100">
                CCMP helps you grow your homoeopathic practice with excellence.
              </h4>
              <Button 
                asChild 
                variant="outline"
                className="border-2 border-orange-500 text-orange-400 hover:bg-orange-500 hover:text-white rounded-xl px-6 py-5 transition-all duration-400 group shadow-lg hover:shadow-orange-500/30"
              >
                <Link to="/membership">
                  Start Your Journey Today
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
          ...
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.1 }}
            >
              <h3 className="text-lg font-semibold mb-6 text-neutral-200">Platform</h3>
              <ul className="space-y-3">
                {platformLinks.map((link) => (
                  <motion.li 
                    key={link.name}
                  ...
                  >
                    <Link 
                      to={link.href} 
                      className="text-neutral-400 hover:text-orange-400 transition-colors duration-300 inline-flex items-center group"
                    >
                      <span className="border-b border-transparent group-hover:border-orange-400 transition-all duration-300">
                        {link.name}
                      </span>
                    </Link>
                  </motion.li>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-lg font-semibold mb-6 text-neutral-200">Resources</h3>
              <ul className="space-y-3">
                {resourceLinks.map((link) => (
                  <motion.li 
                    key={link.name}
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <h3 className="text-lg font-semibold mb-6 text-neutral-200">Legals</h3>
              <ul className="space-y-3">
                {legalLinks.map((link) => (
                  <motion.li 
                    key={link.name}
        ...
        <div className="border-t border-neutral-700/50 py-8">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="text-neutral-400 text-sm">Follow us on:</span>
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center w-11 h-11 bg-neutral-800 hover:bg-gradient-to-br hover:from-orange-500 hover:to-orange-600 border border-neutral-700 hover:border-orange-500 rounded-xl text-neutral-400 hover:text-white transition-all duration-400 shadow-lg hover:shadow-orange-500/30"
                  >
                    {social.icon}
                  </motion.a>
                ))}
