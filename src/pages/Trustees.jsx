    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
            {mockData.trustees.map((trustee) => (
              <Card key={trustee.id} className="hover:shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
                <div className="relative">
                  <img 
                    src={trustee.image} 
                    alt={trustee.name}
                ...
                <CardContent className="p-8">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">{trustee.name}</h3>
                    <p className="text-green-500 font-semibold text-lg">{trustee.designation}</p>
                  </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-gradient-to-br from-orange-50 to-green-50 border-none shadow-xl">
            <CardContent className="p-12 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Message from the Board
              </h2>
              ...
              <div className="text-center">
                <p className="font-semibold text-gray-900 text-lg">The Board of Trustees</p>
                <p className="text-green-500">CCMP Maharashtra</p>
              </div>
            </CardContent>
          </Card>
        </div>
