    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-gradient-to-br from-orange-600 to-orange-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Join the Premier
              <span className="block text-orange-400">Homoeopathic Association</span>
            </h1>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Membership Card */}
            <div className="lg:sticky lg:top-8">
              <Card className="shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 border-2 border-orange-200 relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-green-500 text-white px-4 py-2 rounded-bl-lg">
                  <Star className="w-4 h-4 inline mr-1" />
                  Premium
                </div>
                <CardHeader className="text-center bg-gradient-to-br from-orange-50 to-green-50 pb-8">
            ...
            {/* Registration Form */}
            <div>
              <Card className="shadow-lg hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300">
                <CardHeader>
                  <CardTitle className="text-2xl text-gray-900">Join CCMP Today</CardTitle>
                  <p className="text-gray-600">Complete your membership registration below</p>
                </CardHeader>
                ...
                <CardContent className="p-8">
                  <form onSubmit={handlePayment} className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-green-50 p-6 rounded-lg">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <span className="text-lg font-bold text-gray-900">Total</span>
                        <span className="text-2xl font-bold text-orange-500">₹5,000</span>
                      </div>
                    </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <Card className="hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-6">
                <h4 className="font-semibold text-gray-900 mb-2">What's included in the membership?</h4>
                <p className="text-gray-600">
                  Full access to classical education programs, homoeopathic journals, networking events, research resources, 
